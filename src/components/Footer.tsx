...
const Footer = () => {
  return (
    <footer className="py-12 px-6 bg-luxury text-white">
      <div className="container max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">SpiderLayer</h3>
            <p className="text-gray-300 text-sm">
              The intelligent layer connecting all your hotel systems for exceptional guest service.
            </p>
          </div>
