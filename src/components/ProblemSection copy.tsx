  ...
  return (
    <section id="why-auctores" className="section-padding bg-white">
      <div className="container max-w-4xl mx-auto text-center">
        ...
        Luxury guests expect invisible service. They choose you for care, not convenience. 
        </p>
        ...
        <div className=" rounded-lg p-6   border-champagne/20 relative">
          ...
          <p className="text-navy mt-2 text-lg">
            <span className="font-semibold text-navy">With Auctores:</span> One command, one layer, task closed in 25 seconds. 
            Your team spends the next 14 minutes crafting delight, not data entries.
            Schedule any task across tools in the background and let employees use all tools within one interface. 
