...
<section id="how-it-works" className="section-padding bg-white">
      <div className="container mx-auto max-w-7xl">
        {/* ---------- Headline ---------- */}
        <h2 className="text-center font-playfair text-3xl font-bold text-navy md:text-4xl mb-4">
          How It Works.
        </h2>
        <p className="mx-auto mb-12 max-w-4xl text-center text-lg text-navy/70">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="mb-6 flex w-full items-center justify-between">
                <span className="font-playfair text-5xl text-gray opacity-25">{step.number}</span>
              ...
              <div className="mt-auto">
                ...
                <p className="text-base text-navy/70">{step.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-12 flex flex-col items-center gap-6 text-center">
          <p className="max-w-4xl text-xl text-navy/70">Simple. Yet remarkably powerful.</p>
          <Button
            variant="outline"
            className="h-auto rounded-md border border-champagne bg-transparent px-8 py-4 text-lg font-medium text-champagne transition-all duration-300 hover:bg-champagne/10"
